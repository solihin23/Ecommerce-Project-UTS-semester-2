                            ...
                            <form id="form" method="POST" action="function.php">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 gx-3 mb-3">
                                        ...
                                        <input class="form-control" id="sell_price" name="sell_price" type="text" placeholder="Sell Price" />
                                    </div>
                                    <!-- Form Group (stock)-->
                                    <div class="col-md-12 gx-3 mb-3">
                                    ...
                                    <div class="col-md-12 gx-3 mb-3">
                                        ...
                                        <input class="form-control" id="min_stock" name="min_stock" type="text" placeholder="Min Stock" />
                                    </div>
